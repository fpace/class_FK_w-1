...
struct background
{
  ...
  /* Input parameters for F(K) fluid starts here */

  double Omega0_fk; /*Omega_0 for F(K) fluid */
  double w_fk; /* Equation of state for F(K) fluid */
 /* Initial condition for F(K(a=1)). These first 3 paramters will be needed for the differential equation for F(K). */
  //double c1; /*c1 term in F(K)*/
  //double c2; /*c2 term in F(K)*/
  //double c3; /*c3 term in F(K)*/
  //double c4; /*c4 term in F(K)*/
  //double c13;
  //double c14;
  //double alpha_c;
  //double F0;
  ...
  double P3;
  double P4;
  double a_start_fk; /*When to start perturbation sin F(K)*/

  /* Input parameters for F(K) fluid ends here */
  ...
  /* F(K) starts here */
  int index_bg_K_fk;       /**< K */
  int index_bg_F_fk;       /**< F(K) */
  int index_bg_FK_fk;       /**< F_K */
  int index_bg_FKK_fk;       /**< F_KK */
  int index_bg_FKKK_fk;       /**< F_KKK */
  int index_bg_rho_fk;       /**< F(K) density determined uniquely via w and a*/
  int index_bg_rho_analytic_fk;       /**< F(K) density determined via an analytical expression*/
  int index_bg_w_fk;         /**< F(K) equation of state */
  int index_bg_F0;
  int index_bg_P1;
  int index_bg_P2;
  int index_bg_P3;
  int index_bg_P4;
  //int index_bg_c1;         /**< F(K) coefficient c1 */
  //int index_bg_c2;         /**< F(K) coefficient c2 */
  //int index_bg_c3;         /**< F(K) coefficient c3 */
  //int index_bg_c4;         /**< F(K) coefficient c4 */
  //int index_bg_c13;
  //int index_bg_c14;
  //int index_bg_alpha_c;
  int index_bg_cPD;  
  int index_bg_cPT;
  int index_bg_cPX;
  int index_bg_cPY;
