...
FileName root; //F(K) starts here
  //@{
  double ALPHA_fk;
  double k_max_fk;
  short start_perturbs_fk; //F(K) ends here
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  //@{
  short has_source_lensing_potential_fk; //F(K) starts here
  short has_source_wGamma_fk;
  short has_source_wPi_fk;
  short has_source_Delta_fk;
  short has_source_Delta_m;
  short has_source_Delta_m_nl_factor; //F(K) starts here
  ...
  int index_tp_lensing_potential_fk; //F(K) starts here
  int index_tp_wGamma_fk; 
  int index_tp_wGamma_m; 
  int index_tp_wPi_fk; 
  int index_tp_wPi_m; 
  int index_tp_Delta_fk; 
  int index_tp_mu_fk; 
  int index_tp_eta_fk; 
  int index_tp_Delta_m; 
  int index_tp_Delta_m_nl_factor; //F(K) ends here
  ...
  double **Z_over_Y_fk; 
  double **wPi_fk_today; 
  double **wGamma_fk_today; 
  double **Delta_m_today; 
  double **Delta_fk_today; 
  int index_k_current_fk;
  /*F(K) ends here*/
...
struct perturb_vector
{
  ...
  int index_pt_delta_tilde_fk;  /**F(K) starts here, dark energy DELTA*/
  int index_pt_theta_tilde_fk;  /**F(K) ends here, dark energy THETA*/ 
...
struct perturb_workspace
{
  ...
  //@{
  int index_mt_delta_fk; //F(K) starts here      
  int index_mt_theta_fk; 
  int index_mt_T_fk;           
  int index_mt_Y_fk;           
  int index_mt_W_fk;           
  int index_mt_chi_fk;           
  ...
  int index_mt_wPi_fk;           
  int index_mt_wGamma_fk;           



  int index_mt_delta_tilde_fk;           
  int index_mt_theta_tilde_fk; 
  int index_mt_T_tilde_fk;           
  int index_mt_Y_tilde_fk;           
  int index_mt_W_tilde_fk;           
  int index_mt_chi_tilde_fk;           
  int index_mt_Z_tilde_fk;
  int index_mt_X_tilde_fk;
  
  int index_mt_Pi_tilde_fk;           
  int index_mt_Gamma_tilde_fk;

  int index_mt_c_G_D_fk;
  int index_mt_c_G_T_fk;
  int index_mt_c_G_D_m;
  int index_mt_c_G_T_m;
  int index_mt_c_G_G_m;
  
  int index_mt_c_P_T_fk;
  int index_mt_c_P_D_fk;
  ...
  int index_mt_cb2;
  int index_mt_delta_p_m; //F(K) ends here
