...
int lensing_addback_cl_tt(
  ...
  for (index_l=0; index_l<ple->l_size; index_l++) {
    l = (int)ple->l[index_l];
    ple->cl_lens[index_l*ple->lt_size+ple->index_lt_tt] = (ple->A_lens)*(ple->cl_lens[index_l*ple->lt_size+ple->index_lt_tt]) + cl_tt[l];
  }
  return _SUCCESS_;
...
int lensing_addback_cl_te(
  ...
  for (index_l=0; index_l<ple->l_size; index_l++) {
    l = (int)ple->l[index_l];
    ple->cl_lens[index_l*ple->lt_size+ple->index_lt_te] = (ple->A_lens)*(ple->cl_lens[index_l*ple->lt_size+ple->index_lt_te]) + cl_te[l];
  }
  return _SUCCESS_;
...
int lensing_addback_cl_ee_bb(
  ...
  for (index_l=0; index_l<ple->l_size; index_l++) {
    l = (int)ple->l[index_l];
    ple->cl_lens[index_l*ple->lt_size+ple->index_lt_ee] = (ple->A_lens)*(ple->cl_lens[index_l*ple->lt_size+ple->index_lt_ee]) + cl_ee[l];
